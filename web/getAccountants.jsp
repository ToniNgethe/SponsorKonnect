...
<%
    ...
    if (name == null || name.trim().equals("")) {
        out.print("<div class='alert alert-info'>Please enter Accoutant Email or Number</div>");
    } else {

        Connection conn = DBUtil.getConnection();
        String query = "SELECT * FROM accountant WHERE email = ? OR number = ?";
        try {
            ...
            if (!rs.isBeforeFirst()) {
                ...
                out.println("<div class='alert alert-danger'>No Accountant with that email or Number Found!</div>");
