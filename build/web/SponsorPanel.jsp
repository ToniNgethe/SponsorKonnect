                    ...
                    $.get('GetSponsorAssignedStudServ?sponsor=<%= id%>', function (responseJson) {
                        if (responseJson[0]) {
                            ...
                            $.each(responseJson, function (key, value) {
                                ...
                                rowNew.children().eq(1).text(value['s_name']);
                                rowNew.children().eq(2).text(value['f_name']);
                                rowNew.children().eq(3).text(value['l_name']);
                                ...
                                rowNew.children().eq(5).html('<a class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">monetization_on</i></a>');
...
//                    document.getElementById('selected_third_term_fees').value = x[4].innerHTML;
        ...
        <!-- Modal Structure -->
        <div id="modal4" class="modal white" class="modal modal-lg modal-fixed-footer" data-backdrop="static" data-keyboard="false" style="height: 90%; width: 60%; max-height: 100%; top: 5%; bottom: 5%;">

            <div class="modal-header">
                <div>
                    <img id="student_image" src="ImageServlet?id=" class="circle" alt="" style="width: 150px; height: 150px; margin-left: 40%;margin-top: 2%;"/>
                    <p id="stuent_names" class="teal-text text-lighten-1" style="margin-left: 44%;"></p>
                </div>
